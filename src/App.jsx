    ...
    <>
      ...
      <div style={{ paddingTop: 64 }}>
        ...
        <footer className="footer">
          <div className="footer-logo">ShowUp DC<span className="dot" style={{display:'inline-block',width:6,height:6,background:'#E8472A',borderRadius:'50%',marginLeft:2,marginBottom:2,verticalAlign:'baseline'}} /></div>
